...
CREATE TABLE USUARIOS
  (
    ...
    NM_PRIVILEGIO_USUARIO VARCHAR2 (60) DEFAULT 'Usuário' NOT NULL ,
...
ALTER TABLE USUARIOS ADD CONSTRAINT USUARIOS_UNIQUE UNIQUE (NM_LOGIN_USUARIO);
...
CREATE OR REPLACE TRIGGER CARDAPIOS_CD_CARDAPIO_TRG BEFORE
  INSERT ON CARDAPIOS FOR EACH ROW WHEN (NEW.CD_CARDAPIO IS NULL) BEGIN SELECT CARDAPIOS_CD_CARDAPIO_SEQ.NEXTVAL INTO :NEW.CD_CARDAPIO FROM DUAL;
END;
/

CREATE SEQUENCE EMAILS_CD_EMAIL_SEQ START WITH 1 NOCACHE ORDER ;
CREATE OR REPLACE TRIGGER EMAILS_CD_EMAIL_TRG BEFORE
  INSERT ON EMAILS FOR EACH ROW WHEN (NEW.CD_EMAIL IS NULL) 
    BEGIN 
        SELECT EMAILS_CD_EMAIL_SEQ.NEXTVAL INTO :NEW.CD_EMAIL FROM DUAL;
    END;
/
...
CREATE OR REPLACE TRIGGER ENTREGADORES_CD_ENTREGADOR_TRG BEFORE
  INSERT ON ENTREGADORES FOR EACH ROW WHEN (NEW.CD_ENTREGADOR IS NULL) BEGIN SELECT ENTREGADORES_CD_ENTREGADOR_SEQ.NEXTVAL INTO :NEW.CD_ENTREGADOR FROM DUAL;
END;
/
...
CREATE OR REPLACE TRIGGER ITENS_PEDIDO_CD_PRODUTO_TRG BEFORE
  INSERT ON ITENS_PEDIDO FOR EACH ROW WHEN (NEW.CD_PRODUTO IS NULL) BEGIN SELECT ITENS_PEDIDO_CD_PRODUTO_SEQ.NEXTVAL INTO :NEW.CD_PRODUTO FROM DUAL;
END;
/

CREATE SEQUENCE PEDIDOS_CD_PEDIDO_SEQ START WITH 1 NOCACHE ORDER ;
CREATE OR REPLACE TRIGGER PEDIDOS_CD_PEDIDO_TRG BEFORE
  INSERT ON PEDIDOS FOR EACH ROW WHEN (NEW.CD_PEDIDO IS NULL) BEGIN SELECT PEDIDOS_CD_PEDIDO_SEQ.NEXTVAL INTO :NEW.CD_PEDIDO FROM DUAL;
END;
/
...
CREATE OR REPLACE TRIGGER PRODUTOS_CD_PRODUTO_TRG BEFORE
  INSERT ON PRODUTOS FOR EACH ROW WHEN (NEW.CD_PRODUTO IS NULL) BEGIN SELECT PRODUTOS_CD_PRODUTO_SEQ.NEXTVAL INTO :NEW.CD_PRODUTO FROM DUAL;
END;
/
...
CREATE OR REPLACE TRIGGER REDES_SOCIAIS_CD_REDE_SOCIAL BEFORE
  INSERT ON REDES_SOCIAIS FOR EACH ROW WHEN (NEW.CD_REDE_SOCIAL IS NULL) BEGIN SELECT REDES_SOCIAIS_CD_REDE_SOCIAL.NEXTVAL INTO :NEW.CD_REDE_SOCIAL FROM DUAL;
END;
/
...
CREATE OR REPLACE TRIGGER TIPOS_PRODUTO_CD_TIPO_PRODUTO BEFORE
  INSERT ON TIPOS_PRODUTO FOR EACH ROW WHEN (NEW.CD_TIPO_PRODUTO IS NULL) BEGIN SELECT TIPOS_PRODUTO_CD_TIPO_PRODUTO.NEXTVAL INTO :NEW.CD_TIPO_PRODUTO FROM DUAL;
END;
/
...
CREATE OR REPLACE TRIGGER USUARIOS_CD_USUARIO_TRG BEFORE
  INSERT ON USUARIOS FOR EACH ROW WHEN (NEW.CD_USUARIO IS NULL) BEGIN SELECT USUARIOS_CD_USUARIO_SEQ.NEXTVAL INTO :NEW.CD_USUARIO FROM DUAL;
END;
/
